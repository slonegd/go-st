...
program
    : PROGRAM IDENTIFIER 
      (var_declaration_block | function_decl | function_block_decl)* 
      statement_list
      END_PROGRAM
    ;
...
var_decl
    : IDENTIFIER (COMMA IDENTIFIER)* COLON data_type (ASSIGN expression)? SEMICOLON
    ;
...
equality_expression
    : comparison_expression ((EQUAL | NOT_EQUAL) comparison_expression)?
    ;

comparison_expression
    : additive_expression ((LESS | LESS_EQ | GREATER | GREATER_EQ) additive_expression)?
    ;
